    ...
    return (
        <div>
            <div className="playlist__categories">
                ...
                (
                    (
                        <Row key={category?.title} title={category?.title} fetchUrl={category?.url} seeMoreOfThis={category?.seemore} />
                    )
                )
            ...
            <div className="loadMore__MoodCategories">
                ...
                {moodPlaylists.length === 0 && (
                    <div onClick={(e) => loadMore(categories[0].MOOD)} className="text-xs lg:text-xl md:text-sm justify-center 
